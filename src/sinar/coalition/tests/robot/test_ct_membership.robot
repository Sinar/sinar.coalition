...
#
#  $ bin/test -s sinar.coalition -t test_membership.robot --all
#
...
# 2) Run robot tests:
#
# $ bin/robot /src/sinar/coalition/tests/robot/test_membership.robot
#
...
a Membership 'My Membership'
  Create content  type=Coalition  id=my-membership  title=My Membership
